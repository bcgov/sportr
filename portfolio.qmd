...
tree_ls <- c("Fd","Pl","Sx","At","Bl","Cw","Hw","Py","Ep", "Pw", "Lw") ##what species to include
...
## Run portfolios
```{r run portfolios}
tree_ls <- c("Fd","Pl","Sx","Bl","Cw","Hw","Py", "Pw", "Lw")#"At","Ep",
feas_prob <- data.table(Feas = c(1,2,3,4), PropLoss = c(0.1,0.5,2,5), "NoMort" = c(95,85,60,40))
#feas_prob <- data.table(Feas = c(1,2,3,4), PropLoss = c(0.1,0.1, 0.1, 0.1), "NoMort" = c(95,95, 95,95))
portfolio1 <- run_portfolio(bgc_ss, sibec, si_default = 5, feas, tree_ls, feas_prob, sigma = NULL)
xx <- plot_ef(portfolio = portfolio1$Portfolio, run_list = portfolio1$run_list, current_unit = current_unit, returnValue = 0.9)

portfolio2 <- run_portfolio(bgc_ss, sibec, si_default = 5, feas, tree_ls, feas_prob, sigma = sigma_feas)
...
=======
>>>>>>> 113832c75a2d02d65de43f957b7a6457bae0de31
...
portfolio1 <- run_portfolio(bgc_ss, ccissdev::SIBEC, feas, tree_ls2, feas_prob, sigma = NULL) ##sigma = NULL 
